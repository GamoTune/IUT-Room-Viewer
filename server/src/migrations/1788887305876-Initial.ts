...
export class Initial1788887305876 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "subject" ("id" SERIAL NOT NULL, "code" character varying(20) NOT NULL, "label" character varying(150) NOT NULL, CONSTRAINT "UQ_92374adc6b583e8cf659977e489" UNIQUE ("code"), CONSTRAINT "PK_12eee115462e38d62e5455fc054" PRIMARY KEY ("id"))`,
        );
        await queryRunner.query(
            `CREATE TABLE "teacher" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, CONSTRAINT "UQ_55be152c2c710d5939dae9a86aa" UNIQUE ("name"), CONSTRAINT "PK_2f807294148612a9751dacf1026" PRIMARY KEY ("id"))`,
        );
        await queryRunner.query(`CREATE TYPE "public"."lesson_type_enum" AS ENUM('CM', 'TD', 'TP', 'OTHER')`);
        await queryRunner.query(
            `CREATE TABLE "lesson" ("id" SERIAL NOT NULL, "dedup_key" character varying(40) NOT NULL, "start_utc" TIMESTAMP WITH TIME ZONE NOT NULL, "end_utc" TIMESTAMP WITH TIME ZONE NOT NULL, "type" "public"."lesson_type_enum" NOT NULL, "raw_content" character varying(255) NOT NULL, "subject_id" integer NOT NULL, "teacher_id" integer, CONSTRAINT "UQ_b060bc162689e0b8b983e9193a2" UNIQUE ("dedup_key"), CONSTRAINT "PK_0ef25918f0237e68696dee455bd" PRIMARY KEY ("id"))`,
        );
        ...
        await queryRunner.query(
            `CREATE TABLE "student_group" ("id" SERIAL NOT NULL, "code" character varying(10) NOT NULL, "year" "public"."student_group_year_enum" NOT NULL, "main_group" smallint NOT NULL, "sub_group" character varying(2), CONSTRAINT "UQ_3609c5b82be95c3be931d5ddf32" UNIQUE ("code"), CONSTRAINT "PK_1bd5a468c54488b86d50a117f15" PRIMARY KEY ("id"))`,
        );
        await queryRunner.query(`CREATE INDEX "IDX_e8f7a7d0bc54b5a564fffffced" ON "student_group"  ("year") `);
        await queryRunner.query(
            `CREATE TABLE "lesson_group" ("lesson_id" integer NOT NULL, "group_id" integer NOT NULL, "source_id" integer NOT NULL, CONSTRAINT "PK_339512362cf7756cf2f5c65e6d3" PRIMARY KEY ("lesson_id", "group_id", "source_id"))`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE "lesson" ADD CONSTRAINT "FK_aeaae22f4d629e1df4e54ca9695" FOREIGN KEY ("subject_id") REFERENCES "subject"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "lesson" ADD CONSTRAINT "FK_cfe1b52c46b3d6f61ad5be1663c" FOREIGN KEY ("teacher_id") REFERENCES "teacher"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "lesson_group" ADD CONSTRAINT "FK_0bfd78e7229d01a6b7d9e0eb4ce" FOREIGN KEY ("lesson_id") REFERENCES "lesson"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "lesson_group" ADD CONSTRAINT "FK_8eab14b67feaf09d4239f7d500d" FOREIGN KEY ("group_id") REFERENCES "student_group"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "lesson_group" ADD CONSTRAINT "FK_b33c995745368fff8c0a1424117" FOREIGN KEY ("source_id") REFERENCES "edt_source"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "requests" ADD CONSTRAINT "FK_9e5e2eb56e3837b43e5a547be23" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "lesson_room" ADD CONSTRAINT "FK_b347d1e61e4a47c77b9539c3a00" FOREIGN KEY ("lesson_id") REFERENCES "lesson"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
        );
        await queryRunner.query(
            `ALTER TABLE "lesson_room" ADD CONSTRAINT "FK_a15cb2bc22939c339fcba6bd481" FOREIGN KEY ("room_id") REFERENCES "room"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
        );
    }
