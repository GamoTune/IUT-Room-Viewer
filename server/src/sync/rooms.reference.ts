// ============================================
// 📁 src/sync/rooms.reference.ts
// Référentiel des salles du département informatique
// ============================================

import type { RoomKind } from "../entities/enums.js";
...
export const ROOM_REFERENCE: RoomReference[] = [
    ...
    // Amphithéâtres
    { name: "AmphA", floor: 0, kind: "amphi", displayOrder: 310 },
    { name: "AmphB", floor: 0, kind: "amphi", displayOrder: 320 },
    { name: "AmphC", floor: 0, kind: "amphi", displayOrder: 330 },
];
